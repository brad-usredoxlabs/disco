...
export const LABWARE_TEMPLATES = {
  'reservoir-1': { kind: 'reservoir', rows: 1, cols: 1, wellKeying: 'A01' },
  'reservoir-8': { kind: 'reservoir', rows: 8, cols: 1, wellKeying: 'A01' },
  'reservoir-12': { kind: 'reservoir', rows: 12, cols: 1, wellKeying: 'A01' },
